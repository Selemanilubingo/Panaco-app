                    ...
                    <div class="align-self-center w-100">
                        ...
                        <table class="table mb-0">
                            <tbody>
                                <tr>
                                    <td>
                                        <i class="fas fa-circle text-primary fa-fw"></i>
                                        Chrome
                                ...
                                <tr>
                                    <td>
                                        <i class="fas fa-circle text-warning fa-fw"></i>
                                        Firefox
                                ...
                                <tr>
                                    <td>
                                        <i class="fas fa-circle text-danger fa-fw"></i>
                                        Edge
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <i class="fas fa-circle text-dark fa-fw"></i>
                                        Other
                                    </td>
